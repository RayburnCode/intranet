                    ...
                    div { class: "grid grid-cols-1 md:grid-cols-4 gap-8",
                        ...
                        div { class: "space-y-4",
                            ...
                            div { class: "space-y-2",
                                ...
                                FooterLink { href: Route::Tools {}, text: "Tools" }
                            }
                            ...
                            // Copyright
                            {format!("© {} Company Name. All rights reserved.", year)}
                            p { class: "text-sm text-gray-500 dark:text-gray-400 text-center",
                                "© {chrono::Local::now().year()} Company Name. All rights reserved."
                            }
                        }
                    }
                }
...
// For links that use a string href instead of Route
#[component]
